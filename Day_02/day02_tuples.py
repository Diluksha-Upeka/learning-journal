...
# Size comparison
print(
    sys.getsizeof(modules_1)
)  # Size of modules_1 in bytes - list has more overhead (104)
...
cs_courses = {
    ...
    "Web Development",
    "Python",
}  # 'Python' will be stored only once
print(cs_courses)
...
print(
    cs_courses.difference(bio_courses)
)  # elements in cs_courses but not in bio_courses
